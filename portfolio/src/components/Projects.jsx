    ...
    >
      ...
      <div className="mt-10 bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md flex flex-col md:flex-row md:items-start gap-6">
        ...
        <div className="w-full">
          ...
          <p className="text-gray-700 dark:text-gray-300 mt-2">
            Dashboard interactivo con gráficos dinámicos para visualizar y analizar datos en tiempo real. Incluye comparativas por horas, exportación de gráficos como imagen o PDF, y selección por fechas. Totalmente responsive y con soporte multidioma.
          </p>
          ...
          <div className="mt-4">
            <a
              href="https://dashboard-mu-nine-48.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 dark:text-blue-400 hover:underline"
            >
